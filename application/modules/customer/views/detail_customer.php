		...
		<div class="col-xl-3 col-md-6 mb-4">
			<div class="card border-bottom-success shadow  mb-4 ">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					...
					<a href="<?php echo site_url('customer/edit/'.$customer['cust_id']);?>"
						class="btn btn-primary btn-sm btn-circle">
						<i class="fas fa-user-edit"></i>
					</a>
					<a href="#" data-toggle="modal" data-target="#send"
						class="btn btn-dark btn-hover btn-sm btn-circle">
			...
			<div class="card border-bottom-warning shadow mb-4">
				...
				<div class="card-body justify-content-start">
					...
					<div class="btn-group-sm">
						<a href="<?php echo site_url('customer/account_suspend/'.$customer['cust_id']);?>"
						...
						<a href="<?php echo site_url('customer/account_renew/'.$customer['cust_id']);?>"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="modal-footer">
						...
						<a class="btn btn-success btn-circle" id="sendsms"><i class="fas fa-paper-plane"></i></a>
					</div>
					<?php echo form_close();?>
