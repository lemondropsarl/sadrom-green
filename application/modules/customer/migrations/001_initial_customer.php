...
class Migration_initial_customer extends MY_Migration{
    ...
    public function __construct()
    {
        parent::__construct();
        $this->load->dbforge();
        $this->load->config('customer/customer',TRUE);
    ...
    public function up(){
        ...
        $this->dbforge->create_table($this->tables['customers'],TRUE);
        ...
        $this->dbforge->create_table($this->tables['subscriptions'],TRUE);
        //dumb some data
        ...
        $this->dbforge->create_table($this->tables['accounts'],TRUE);
        
        $query = 'ALTER TABLE'.' '. $this->tables['customers'].' '.'ADD CONSTRAINT fk_id FOREIGN KEY (area_id) REFERENCES '.$this->tables['areas'].'(area_id)';
        //$this->db->query($query);
        //creating views
